...
export const InputTextSearchContacts = () => {
    return (
        <div className="bg-primary w-full h-7 rounded-lg flex overflow-hidden">
            <input type="text" className="w-5/6 bg-transparent placeholder:text-gray-700 placeholder:text-xs text-xs p-3 text-slate-200 h-full outline-none" placeholder="Procurar Contato" />
